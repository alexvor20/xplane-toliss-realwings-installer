...
1. AFTER the change in files copy all the content from CEO and NEO folders into Toliss a321 objects folder. (yes, in one folder) (only one file should be overwritten `custom_decal.png`, which is identical for both folders)
